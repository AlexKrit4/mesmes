  ...
  return (
    <div className="chat-page" ref={chatPageRef}>
      ...
      {(() => {
        ...
        const topPinned = pinned[pinned.length - 1];
        ...
        return (
          <div className="pinned-message-bar" onClick={() => {
            ...
            <div className="pinned-content">
              <div className="pinned-title">Закрепленная запись</div>
              <div className="pinned-text">{topPinned.file_url ? 'Вложение' : (topPinned.content || '...')}</div>
            </div>
            {isOwner && (
              <button className="pinned-close" onClick={(e) => { e.stopPropagation(); pinChannelMessage(topPinned.id); }} title="Открепить">
      ...
      <div className="messages-area" ref={messagesAreaRef}>
        ...
        {messages.map((msg, idx) => {
          ...
          <React.Fragment key={msg.id}>
            ...
            <div id={`msg-${msg.id}`} className="message-row out">
